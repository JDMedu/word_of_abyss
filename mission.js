...
const WEEKLY=[
  ...
  MK('w44','mid','구슬을 두 번 진화시키기','evo',2),
...
(function(){
  ...
  st.textContent=
   ...
   +'margin:2.4em 0 .3em;padding-bottom:.4em;border-bottom:2px solid rgba(229,178,79,.5)}'
   +'.misHead:first-child{margin-top:.2em}'
   +'.misHead span{font-family:var(--font-carve);font-size:1.5em;'
   +'letter-spacing:.06em;color:var(--gold)}'
   +'.misHead i{font-family:var(--font-ui);font-size:.82em;font-style:normal;'
   +'font-weight:700;color:var(--stone-deep)}'
